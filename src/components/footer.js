  ...
  return (
    <React.Fragment>
      ...
      <div className='bg-[#262322] py-10 cut'>
        <div className='container mx-auto flex flex-col justify-center text-white f-f-p w-full sm:w-8/12'>
          <div className='flex flex-wrap w-full justify-between items-start pt-24 pb-10 px-4'>
            <div className='flex flex-col justify-center space-y-4 pr-2 sm:pr-10 lg:pr-0 mb-10 lg:mb-0'>
            ...
            <form className='flex flex-col justify-center space-y-4 pr-10 lg:pr-0'>
          ...
          <div className="flex flex-col space-y-2 lg:space-y-0 lg:flex-row-reverse w-full justify-between pt-3">
            ...
            <div className="flex flex-wrap">
              <a href="/" className="text-sm leading-4 f-f-p font-medium pr-6">Returns</a>
              <a href="/" className="text-sm leading-4 f-f-p font-medium pr-6">Privacy Policy</a>
